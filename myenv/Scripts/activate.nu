...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\dsudh\OneDrive\Documents\python program\Food Order System\myenv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\dsudh\OneDrive\Documents\python program\Food Order System\myenv\Scripts\deactivate.nu'
